...
class Config(object):
    def __init__(self, config_file):
        ...
        self.share_v = conf.getfloat("Model_Setup", "share_v")
        self.spec_v = conf.getfloat("Model_Setup", "spec_v")
        self.sim_v = conf.getfloat("Model_Setup", "sim_v")
        self.s_rec = conf.getfloat("Model_Setup", "s_rec")
        self.kl_loss = conf.getfloat("Model_Setup", "kl_loss")
        self.l_knn = conf.getint("Model_Setup", "l_knn")
        ...
        # self.structattgraph_path = conf.get("Data_Setting", "structattgraph_path")
        # self.ifatt = conf.get("Data_Setting", "att")
